...
def gen_per_iretation(parameters_yaml_file:str, model_state_name:str, result_save_name:str):
    ...
    checkpoint = torch.load('/home/rokubo/data/diffusion_model/model_state/model_to_predict_epsilon/'+model_path+'.pth', map_location=device, weights_only=False)
