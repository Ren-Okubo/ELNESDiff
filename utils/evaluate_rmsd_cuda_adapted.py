...
if __name__ == '__main__':
    ...
    original_graph_list = torch.load(config['original_graph_save_path'], map_location=device, weights_only=False)
    generated_graph_list = torch.load(config['generated_graph_save_path'], map_location=device, weights_only=False)
